...
const ImageFieldProof: React.FC<ImageFieldProps> = ({
  label,
  img,
  id,
  status,
  ...
  return (
    <div className="w-full flex flex-col gap-1 mb-3 ">
      {image.length == 0 ? (
        <label
          className="flex justify-center flex-col items-center border-2 border-[#e2e2e2] w-1/2 aspect-square rounded-xl cursor-pointer"
          htmlFor="fileInput"
        >
          <MdOutlineAddPhotoAlternate className="text-neutral-500 text-4xl" />
          <p className="text-neutral-500 text-[12px] my-1">Add image proof</p>
          <input
            type="file"
            id="fileInput"
            accept="image/*"
        ...
        <div className="flex justify-center flex-col">
          ...
          {status !== "Resolved" && (
            <label
              className="mt-5 flex justify-center flex-col items-center border-2 border-[#e2e2e2] w-1/2 aspect-square rounded-xl cursor-pointer"
              htmlFor="fileInput"
            >
              <MdOutlineAddPhotoAlternate className="text-neutral-500 text-4xl" />
...
export default ImageFieldProof;
